...
2. QUIZ: Complete the L2: Mental Imagery quiz (6 points, on Canvas)
3. WRITING: There are two options to choose from. (1) React to a podcast (6 points, instructions below, submit on Canvas) or (2) Introspect on your own mental imagery (6 points, instructions below, submit on Canvas)
...
### Writing Option 1: React to a Many Minds podcast (6 points)
...
### Writing Option 2: Introspect on your own mental imagery (6 points)
