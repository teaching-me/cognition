...
1. QUIZ: Complete the L2: Mental Imagery quiz (5 points, on Canvas)
2. WRITING: There are two options to choose from. (1) React to a podcast (5 points, instructions below, submit on Canvas) or (2) Introspect on your own mental imagery (5 points, instructions below, submit on Canvas)
