...
3. QUIZ: Complete the L4: Associations quiz (5 points, on Canvas)
...
### Writing Option 1: QALMRI for paper on associative strength and free recall (5 points)
...
### Writing Option 2: Blocking in the Rescorla-Wagner model (5 points)
