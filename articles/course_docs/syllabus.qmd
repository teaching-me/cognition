...
Grades will be determined based on the following rubric, which is based on emphasizing our [three learning goals](https:/teaching-cognition.github.io/articles/course_docs/syllabus.html#why-take-this-course-a.k.a.-learning-goals)
...
|:------------------|-------:|---------:| -------------:|
| Weekly Assignments |     5+ | up to 70 | <span style="color:#3065DF">Understand</span>, <span style="color:#2AC8B0">Connect</span>, <span style="color:#D432DC">Reflect</span> |
| Class participation      |      5 |        5 | <span style="color:#2AC8B0">Connect</span>, <span style="color:#D432DC">Reflect</span> |
| Assessment 1      |      7.5 |        7.5 | <span style="color:#3065DF">Understand</span>, <span style="color:#2AC8B0">Connect</span> | 
| Assessment 2      |      7.5 |        7.5 | <span style="color:#3065DF">Understand</span>, <span style="color:#2AC8B0">Connect</span> |
...
### Assignments (up to 70 points)

Each weekly module will contain two or more assignment opportunities of two types: quizzes and short writing assignments. In general, quizzes and writing assignments are both worth 5 points each. Students can complete as many quizzes or assignments as they want, for a maximum of 70 points toward their final grade. **Students are strongly encouraged to complete at least one assignment per module**. 

In addition to the *weekly* assignments, which focus on the details of module content, there are also opportunities to complete more *general* assignments (more details [here](https://teaching-cognition.github.io/cognition/articles/modules/General_Assignments.html))

### Class participation (5 points)

Students are encouraged to participate during class by responding to and reflecting on the course content, as well as engaging with other students via activities and group work. Your attendance will also count for some part of your class participation. Additionally, there will be opportunities to gain participation points via discussion boards on Canvas. See instructions on Canvas for individual discussion boards.
...
In-class participation will be assessed based on how engaged you are in class - this does not mean that you need to talk in each class, but I will be looking for engagement via participating in activities, asking questions, volunteering answers, etc. on an *overall* basis.
...
You will also work on a final project for this class. The project can be completed in a few different ways and provides you with the opportunity to work individually or in a group. More details about final projects are available [here](https://teaching-cognition.github.io/cognition/articles/modules/Final_Projects.html) and will also be discussed in class. You have six different options for your final project, these are briefly described below:

1. **Minute Cognition (groups of 2)**: Create a 3 to 5 minute video on any instance of cognition.
2. **Gamifying Cognition (groups of 2)**: Create a game that tests an instance of cognition.
3. **Cognition in Film (groups of 2)**: Explore a cognitive phenomenon in the realistic or fictionalized world of a film. 
4. **Analyze AI**: Select and analyze any real-world example of AI from a cognitive lens.
5. **Podcast Pondering**: Select a podcast from the [Many Minds archive](https://manyminds.libsyn.com/) and analyze the discussion in the podcast from a *cognitive* perspective.
6. **Data Dive**: Analyze the main patterns from a dataset from cognitive psychology provided by me.
...
2. Flex days may ONLY be used for weekly assignments and your final project. If your final project is a group project, both individuals will need to use up flex days for extensions.
