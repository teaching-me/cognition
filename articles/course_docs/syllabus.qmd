...
| [Research summaries](#research-summaries)     |   5 | <span style="color:#2AC8B0">Connect</span>, <span style="color:#D432DC">Reflect</span> |
...
- **Choosing a review article**: Review articles summarize the existing literature on a particular topic. You must find and read a broad review article from [Annual Reviews of Psychology](https://www.annualreviews.org/journal/psych) OR [Psychonomic Bulletin and Review](https://www.springer.com/journal/13423), and then submit a SPARK summary for the same. Your SPARK summary is worth 1.5 points.
