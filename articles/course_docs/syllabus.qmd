...
|:------------------|-------:|---------:| -------------:|
| [Weekly quizzes](#weekly-quizzes) |  30 | <span style="color:#3065DF">Understand</span>, <span style="color:#2AC8B0">Connect</span>, <span style="color:#D432DC">Reflect</span> |
...
| [Class participation](#project-work)     |   5 | <span style="color:#2AC8B0">Connect</span>, <span style="color:#D432DC">Reflect</span> |
| [Extra credit](#extra-credit) |  3 |  <span style="color:#D432DC">Reflect</span> |
|           Total        |    103    |       |
...
***Picking a review article***:  You must find and read a broad review article from [Annual Reviews of Psychology](https://www.annualreviews.org/journal/psych) OR [Psychonomic Bulletin and Review](https://www.springer.com/journal/13423), and then submit a SPARK summary for the same.

***Picking a podcast***:  You must find and listen to a podcast from [Many Minds](https://manyminds.libsyn.com/) or [Science Vs](https://gimletmedia.com/shows/science-vs/episodes#show-tab-picker) and then submit a SPARK summary for the same.


##### Milestone 3: Empirical article list + argument (5 points)

In this milestone, you will find at least 3 empirical articles on your chosen topic. Empirical articles typically describe an experiment or a collection of experiments that attempt to answer a research question. 
